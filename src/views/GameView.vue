...
import UnityProgress from '../../public/Touch_WEB/TemplateData/UnityProgress'
...
export default {
    ...
    mounted() {
        ...
        if (this.isMobile()) {
            this.unityInstance = UnityLoader.instantiate("unityContainer", "Touch_WEB/Build/Touch_WEB.json", {onProgress: UnityProgress});
            document.querySelector('button').click()
            
        }
        else {
            this.unityInstance = UnityLoader.instantiate("unityContainer", "NoTouch_Web/Build/NoTouch_Web.json", {onProgress: UnityProgress});
