...
export default {
    mounted() {
        this.unityInstance = UnityLoader.instantiate("unityContainer", "WEBGL/Build/WEBGL.json", {onProgress: UnityProgress});
    }
